...
final class ClienteController extends AbstractController
{
    ...
    #[Route('/buscar/{nombre}', name: 'app_cliente_buscarPorNombre', methods: ['GET'])]
    public function buscarPorNombre(ClienteRepository $clienteRepository, string $nombre): Response
    {
      
        return $this->render('cliente/index.html.twig', [
            'clientes' => $clienteRepository->findBy(['nombre' => $nombre]),
        ]);
    }
    ...
    #[Route('/descarga/manual/usuario', name: 'app_descargar_manual', methods: ['GET'])]
    public function download(ClienteRepository $clienteRepository, string $nombre): Response
    {
